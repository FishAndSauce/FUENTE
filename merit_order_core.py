...
residual_demand = demand_profile.superpose(other_demand_series=[solar_profile, wind_profile], test_plot=True, time_unit='hours', time_interval=1)

start = time.clock()
load_duration_curve = residual_demand.create_load_duration_curve(as_percent=False, as_proportion=True, granularity=10000, calculate_area=True)
...
residual_demand.plot_power_series()
